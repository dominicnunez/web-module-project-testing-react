...
describe('Episode component', () => {
  ...
  test("renders texts and alt texts correctly", () => {
    ...
    screen.getAllByText(exampleEpisodeData.summary)
    ...
    const imageUrl = "https://i.ibb.co/2FsfXqM/stranger-things.png"
    expect(document.querySelector(`img[src="${imageUrl}"]`)).toBeInTheDocument();
